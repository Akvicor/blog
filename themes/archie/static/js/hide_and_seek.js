...
if (isMobile.any) {
    ...
    function handleTouchMove(evt) {
        ...
        if (pointer >= callAction.length) {
            displayed = true;
            var hide_and_seek_tags = document.getElementsByTagName('hide_and_seek');
            for(var i = 0, l = hide_and_seek_tags.length; i < l; i++) hide_and_seek_tags[i].style.display = 'block';
            var hide_and_seek = document.getElementsByTagName('hide_and_seek')[0];
        }
        xDown = null;
        yDown = null;
    };
